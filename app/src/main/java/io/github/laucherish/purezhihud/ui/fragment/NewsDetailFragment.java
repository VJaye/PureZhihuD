...
//        slide.addTarget(R.id.wv_news);
//        slide.setDuration(1000);
        Fade fadeOut = new Fade(Visibility.MODE_IN);
//        fadeOut.addTarget(R.id.wv_news);
        fadeOut.setDuration(50);
//        getActivity().getWindow().setEnterTransition(slide);
//        getActivity().getWindow().setSharedElementEnterTransition(fadeOut);
