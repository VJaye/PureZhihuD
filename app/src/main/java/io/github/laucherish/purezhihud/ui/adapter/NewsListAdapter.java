        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat activityOptions = ActivityOptionsCompat.makeSceneTransitionAnimation(
                        (Activity) mContext,
                        new Pair<View, String>(holder.mIvNews, mContext.getString(R.string.transition_image_view))
                );
                NewsDetailActivity.start((Activity) mContext, news, activityOptions.toBundle());
            }
        };
    }
